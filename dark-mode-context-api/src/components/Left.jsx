    ...
    return (
        <Wrapper>
            ...
            <Middle>
                ...
                <div style = {{textAlign: 'center'}}><img style = {{ width: "31px", height: "40px", borderRadius: "5px"}} src = "https://img.icons8.com/external-kmg-design-flat-kmg-design/72/external-sign-post-maps-navigation-kmg-design-flat-kmg-design.png" alt = "network" /></div>
                <div style = {{textAlign: 'center'}}><img style = {{ width: "31px", height: "40px", borderRadius: "5px"}} src = "https://cdn-icons.flaticon.com/png/128/2022/premium/2022197.png?token=exp=1637164905~hmac=4e26810d78e6617dd2383a81a97da1e4" alt = "network" /></div>
                <div style = {{textAlign: 'center'}}><img style = {{ width: "31px", height: "40px", borderRadius: "5px"}} src = "https://cdn-icons.flaticon.com/png/128/2594/premium/2594058.png?token=exp=1637164995~hmac=61a06da64caa855f7e21ad4e43223483" alt = "network" /></div>
